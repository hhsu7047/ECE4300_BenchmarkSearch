...
int binarySearch(vector<int> & v, int start, int end, int elem){
    ...
    // Note: start + (end - start) / 2 is used to prevent integer overflow
...
double average(const vector<double> a){
    ...
    // Use a range-based for loop to easily add up all elements
...
int main(){
  vector<int> elem_to_find;
    ...
    // ==========================================
    avg.clear(); // Reset averages for the next algorithm
